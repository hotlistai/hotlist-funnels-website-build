      ...
      <section className="py-24 border-b border-border">
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          >
            ...
            <motion.p variants={fadeIn} className="text-xl text-muted-foreground">
              Everything you need to create instant engagement and qualified leads
            </motion.p>
          </motion.div>
...
const industries = [
  {
    icon: Building2,
    name: "Real Estate",
    description: "Quiz: \"Is Your Home Worth More Than You Think?\" with free valuation guide",
    href: "/real-estate",
  },
  {
    icon: Sun,
    name: "Solar",
    description: "Quiz: \"Are You Overpaying for Electricity?\" with 50% off consultation",
    href: "/solar",
  },
  {
    icon: Scale,
    name: "Legal",
    description: "Quiz: \"Is Your Case Worth Pursuing?\" with free case evaluation",
    href: "/legal",
  },
  {
    icon: UtensilsCrossed,
    name: "Restaurants",
    description: "Quiz: \"What's Your Hiring Blind Spot?\" with free recruitment strategy",
    href: "/restaurants",
  },
  {
    icon: Hammer,
    name: "Contractors",
    description: "Quiz: \"Is Your Home at Risk?\" with 25% off first project",
    href: "/contractors",
  },
  {
    icon: HardHat,
    name: "Blue Collar",
    description: "Quiz: \"Are You Losing Money on Bad Hires?\" with free hiring assessment",
    href: "/blue-collar",
  },
  {
    icon: Heart,
    name: "Nonprofits",
    description: "Quiz: \"Which Cause Matches Your Values?\" with exclusive donor guide",
    href: "/nonprofits",
  },
  {
    icon: Dumbbell,
    name: "Fitness",
    description: "Quiz: \"What's Holding You Back From Your Goals?\" with 50% off membership",
    href: "/fitness",
  },
]
        ...
        <div className="max-w-7xl mx-auto px-6 lg:px-8">
          ...
          >
            <motion.h2
              ...
              className="font-serif text-4xl md:text-5xl font-semibold mb-4"
            >
              Quiz Funnel Examples by Industry
            </motion.h2>
            <motion.p variants={fadeIn} className="text-xl text-muted-foreground">
              FOMO-driven quizzes that create emotional impact and instant action
            </motion.p>
          </motion.div>
