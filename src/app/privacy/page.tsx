    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="max-w-4xl mx-auto px-6 py-24">
        ...
        <div className="prose prose-slate max-w-none">
          ...
          <p className="mb-4">At HOTLIST FUNNELS, we prioritize your privacy and are committed to protecting your personal data. This policy outlines how we handle information collected through our conversion systems.</p>
