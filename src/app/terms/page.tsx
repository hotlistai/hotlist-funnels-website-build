    ...
    <div className="min-h-screen bg-background">
      ...
      <main className="max-w-4xl mx-auto px-6 py-24">
        ...
        <div className="prose prose-slate max-w-none">
          ...
          <p className="mb-4">By accessing or using the Hotlist Engine website and services, you agree to comply with and be bound by the following terms and conditions.</p>
          <h2 className="text-xl font-bold mt-8 mb-4">Service Description</h2>
          <p className="mb-4">Hotlist Engine provides lead generation and conversion system services. We do not guarantee specific revenue outcomes as they depend on various factors including market conditions.</p>
          ...
          <p className="mb-4">All content, systems, and "engines" forged by Hotlist Engine are the intellectual property of Hotlist Engine or its licensors.</p>
        </div>
      </main>
      <Footer />
    </div>
